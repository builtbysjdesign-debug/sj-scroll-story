(function() {
  ...
  if (document.querySelector('.sj-scroll-story')) return;

  // ===== INJECT HTML =====
  const html = `
  (() => {
<section class="sj-scroll-story" aria-label="About SJ Design">
  <div class="sj-scroll-track">

    <!-- PANEL 1: About Us - Meet the Team -->
    <article id="about-panel" class="sj-panel sj-panel-about" data-panel="0" data-label="About">
      <div class="sj-about-container">
        <h2 class="sj-about-heading sj-anim-item">What's better than one Squarespace Designer?</h2>
        
        <div class="sj-about-layout">
          <!-- Left: Text Content -->
          <div class="sj-about-content">
            <p class="sj-about-intro sj-anim-item" data-delay="1">
              Meet <strong>Shawn</strong> and <strong>Jake</strong>, the duo behind SJ Design. Together they design and build smart, custom Squarespace sites that feel refined, load fast, and <strong>work for real businesses</strong>.
            </p>
            <p class="sj-about-intro sj-anim-item" data-delay="1">
              No templates, no handoffs, no faff, just <strong>thoughtful design</strong> from first idea to launch.
            </p>
            <p class="sj-about-intro sj-anim-item" data-delay="1">
              Want a site that looks sharp, and reflects your brand? <strong>You're in the right place.</strong>
            </p>
            <a href="/bookacall" class="sj-about-btn sj-anim-item" data-delay="2">Start Your Project</a>
          </div>
          
          <!-- Right: Team Photos -->
          <div class="sj-about-photos">
            <div class="sj-photo-card sj-anim-item" data-delay="1">
              <div class="sj-photo-frame">
                <img src="https://static1.squarespace.com/static/6841fc8015d20948282d5de1/t/694304589780d549b1d15554/1765999705235/thesoundbrother-squarespace.png" alt="Jake - Squarespace Web Designer Liverpool | Custom Website Design Expert at SJ Design" class="sj-photo-img" loading="lazy">
              </div>
              <span class="sj-photo-name">(Jake)</span>
            </div>
            <div class="sj-photo-card sj-anim-item" data-delay="2">
              <div class="sj-photo-frame">
                <img src="https://static1.squarespace.com/static/6841fc8015d20948282d5de1/t/6943042098e7aa44895c51c7/1765999649227/squarespace-designer-shawn.png" alt="Shawn - Squarespace Web Designer UK | Professional Website Developer at SJ Design" class="sj-photo-img" loading="lazy">
              </div>
              <span class="sj-photo-name">(Shawn)</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- PANEL 2: Based in Liverpool -->
    <article id="liverpool" class="sj-panel sj-panel-liverpool" data-panel="1" data-label="Liverpool" style="--sj-video-poster: url('https://static1.squarespace.com/static/6841fc8015d20948282d5de1/t/693d9dea9a76ee262d6828f7/1765645802564/DJI_0337-min.jpg');">
      <div class="sj-panel-bg">
        <video class="sj-panel-video" muted playsinline loop preload="none" poster="https://static1.squarespace.com/static/6841fc8015d20948282d5de1/t/693d9dea9a76ee262d6828f7/1765645802564/DJI_0337-min.jpg" src="https://static1.squarespace.com/static/6841fc8015d20948282d5de1/t/693a7a17c326786b9df7a6da/1765440031891/liver-building-loop.mp4"></video>
      </div>
      <div class="sj-panel-overlay"></div>
      <div class="sj-panel-inner">
        <div class="sj-glass-card">
          <span class="sj-glass-corner sj-glass-corner--tl" aria-hidden="true">+</span>
          <span class="sj-glass-corner sj-glass-corner--br" aria-hidden="true">+</span>
          <h2 class="sj-panel-heading sj-anim-item">Based in Liverpool, UK.</h2>
          <p class="sj-panel-subheading sj-anim-item" data-delay="1"><a class="sj-inline-link" href="https://builtbysj.com/web-designer-liverpool">Liverpool web designers</a>, working globally.</p>
          <p class="sj-panel-body sj-anim-item" data-delay="1">We also work across the <strong>UK and internationally</strong>, offering clear communication, reliable timelines, and a hands-on approach to every project.</p>
          <p class="sj-panel-body sj-anim-item" data-delay="1">Wherever you're based, <strong>you'll be working directly with us</strong>.</p>
          <a href="/#contact" class="sj-panel-btn sj-anim-item" data-delay="2">Get in touch</a>
        </div>
      </div>
    </article>

    <!-- PANEL 3: Results -->
    <article id="results" class="sj-panel sj-panel-dark" data-panel="2" data-label="Results">
      <div class="sj-grid-glow"></div>
      <div class="sj-panel-inner">
        <div class="sj-panel-cards">
          <div class="sj-glass-card">
            <span class="sj-glass-corner sj-glass-corner--tl" aria-hidden="true">+</span>
            <span class="sj-glass-corner sj-glass-corner--tr" aria-hidden="true">+</span>
            <span class="sj-glass-corner sj-glass-corner--bl" aria-hidden="true">+</span>
            <span class="sj-glass-corner sj-glass-corner--br" aria-hidden="true">+</span>
            <h2 class="sj-panel-heading sj-anim-item">Make your site work for you.</h2>
            <p class="sj-panel-subheading sj-anim-item" data-delay="1">A well-designed site should <strong>earn its keep</strong>.</p>
            <p class="sj-panel-body sj-anim-item" data-delay="1">We turn underperforming pages into high-value experiences that convert visitors into loyal customers.</p>
            <p class="sj-panel-body sj-anim-item" data-delay="1">We design Squarespace sites that feel great to use and perform even better. Cleaner journeys, and layouts that guide visitors exactly where you want them.</p>
            <a href="https://builtbysj.com/contact-us" class="sj-panel-btn sj-anim-item" data-delay="2">Get a quote</a>
          </div>
          <div class="sj-glass-card sj-glass-card--image">
            <span class="sj-glass-corner sj-glass-corner--tl" aria-hidden="true">+</span>
            <span class="sj-glass-corner sj-glass-corner--tr" aria-hidden="true">+</span>
            <span class="sj-glass-corner sj-glass-corner--bl" aria-hidden="true">+</span>
            <span class="sj-glass-corner sj-glass-corner--br" aria-hidden="true">+</span>
            <h3 class="sj-panel-heading sj-anim-item">Start Your Project</h3>
            <img
              src="https://static1.squarespace.com/static/6841fc8015d20948282d5de1/t/69791ec8f56bb57cd30d462d/1769545416376/SJ+MAC+%281%29.png"
              alt="squarespace macbook, squarespace designer uk"
              class="sj-card-image"
              loading="lazy"
              decoding="async"
              width="1028"
              height="618.5"
            />
            <p class="sj-panel-subheading sj-anim-item" data-delay="1">New website or redesign? We’ll help you get it right from day one.</p>
            <a href="/bookacall" class="sj-panel-btn sj-anim-item" data-delay="2">Book a call</a>
          </div>
        </div>
      </div>
    </article>
  ...
  <!-- Progress Indicator - RENAMED to avoid conflict with site nav -->
  <nav class="sj-progress-nav" aria-label="Section navigation">
    <div class="sj-progress-track"><div class="sj-progress-bar"></div></div>
    <div class="sj-progress-labels"></div>
  </nav>
</section>
`;
  `;
...
`;
 ...
 const mount = (document.currentScript && document.currentScript.parentElement) || document.body;
...
(function() {
  ...
  const c = document.querySelector('.sj-scroll-story');
  if (!c) return;
  ...
  const initScrollStory = () => {
    ...
    if (liverpoolVideo && liverpoolPanel && liverpoolBg) {
      ...
      // Check on scroll (already have listener) - piggyback
      const originalOnScroll = onScroll;
      const wrappedOnScroll = () => { originalOnScroll(); checkVideo(); };
      removeEventListener('scroll', onScroll, { passive: true });
      addEventListener('scroll', wrappedOnScroll, { passive: true });
    }
  };
